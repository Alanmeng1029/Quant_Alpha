...
def backtest_targets(catalog: Path, target_weights: Path, output: Path, buy_bps: float = 2.0, sell_bps: float = 2.0, initial_capital: float = 10_000_000.0, lot_size: int = 100, return_basis: str = "qfq", rebalance_band: float = 0.0) -> dict:
